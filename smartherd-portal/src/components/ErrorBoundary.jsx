            ...
            return (
                <div style={{
                    ...
                    <div style={{ maxWidth: '480px' }}>
                        ...
                        <h2 style={{ margin: '0 0 0.6rem' }}>Something went wrong</h2>
                        <p style={{ color: '#a0a0a0', fontSize: '0.9rem', marginBottom: '1.2rem' }}>
                            The portal hit an unexpected error and couldn't continue rendering. Your locally-saved
                            data is safe. Reloading usually fixes this.
                        </p>
                        <pre style={{
